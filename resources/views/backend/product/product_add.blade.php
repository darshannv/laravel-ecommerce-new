                        ...
                        <div class="row">  
                            <div class="col-md-4">
                                ...
                                <div class="form-group validate">
                                    ...
                                    <div class="controls">
                                        <select name="select"  name="brand_id" class="form-control">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group validate">
                                    ...
                                    <div class="controls">
                                        <select name="select"  name="category_id" class="form-control">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group validate">
                                    ...
                                    <div class="controls">
                                        <select name="select"  name="subcategory_id" class="form-control">
