                          ...
                          <h2 class="title">
                            ...
                            @endphp
                                        ...
                                        <ul class="links list-unstyled">
                                          <li><a href="#">@if(session()->get('language') == 'hindi'){{ $subsub->subsubcategory_name_hin }} @else {{ $subsub->subsubcategory_name_en }}  @endif</a></li>
                      ...
                      <div class="products">
                        <div class="product">
                          <div class="product-image">
                            ...
                            <div class="tag new"><span>{{ $product->product_tags_en }} </span></div>
                          </div>
                          <!-- /.product-image -->
...
@endphp
                   ...
                   @forelse($catwiseProduct as $product) 
                    ...
                    <h5 class="text-danger" style="text-align: center;">No products Found</h5>
