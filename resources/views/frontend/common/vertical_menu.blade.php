                  ...
                  <h2 class="title">
                    ...
                    @endphp
                                ...
                                <ul class="links list-unstyled">
                                  <li><a href="{{ url('subsubcategory/product/'. $subsub->id.'/'.$subsub->subsubcategory_slug_en) }}">@if(session()->get('language') == 'hindi'){{ $subsub->subsubcategory_name_hin }} @else {{ $subsub->subsubcategory_name_en }}  @endif</a></li>
